...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `infoblox` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-infoblox
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/gpduck/newinfoblox/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-infoblox/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-infoblox_darwin_amd64_v1
│   └── pulumi-resource-infoblox
├── pulumi-infoblox_darwin_arm64
│   └── pulumi-resource-infoblox
├── pulumi-infoblox_linux_amd64_v1
│   └── pulumi-resource-infoblox
├── pulumi-infoblox_linux_arm64
│   └── pulumi-resource-infoblox
├── pulumi-infoblox_windows_amd64_v1
│   └── pulumi-resource-infoblox.exe
└── pulumi-infoblox_windows_arm64
    └── pulumi-resource-infoblox.exe
```
